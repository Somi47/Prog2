...
bool equaltrue( const int&, const int& )
{
	return true;
}

bool equalfalse( const int&, const int& )
{
	return false;
}
...
int main() {
	...
	Set<int, 1, equaltrue> mysettrue;
	mysettrue.insert( 55 );
	bool result = mysettrue.isElement( 1 );
	Set<int, 1, equalfalse> mysetfalse;
	mysetfalse.insert( 55 );
	result = mysetfalse.isElement( 1 );
