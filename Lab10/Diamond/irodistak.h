/**
 * \file irodistak.h
 * Minden származtatott osztály deklarációját ebbe e fájlba tettük.
...
/**
 * Határozott idejû alkalmazott
 */
class HatIdeju : virtual public Alkalmazott {
protected:
    time_t  ido;                // szerzõdése lejár ekkor
public:
...
/**
 * Határozott idejû csoportvezetõ
 */
...
/**
 * Határozott idejû csoportvezetõ helyettes
 */
